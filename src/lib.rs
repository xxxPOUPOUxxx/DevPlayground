// src/lib.rs
/*
 * Core library for DevPlayground
 */
...
#[derive(Debug)]
pub struct DevPlaygroundProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DevPlaygroundProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DevPlayground processing");
    
    let mut processor = DevPlaygroundProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DevPlaygroundProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DevPlaygroundProcessor::new(false);
